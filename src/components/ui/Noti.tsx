...
const Noti = ({ message, dismissTime = 7000, onClose }: NotiProps) => {
  ...
  return (
    <div className={`fixed top-16 left-0 right-0 z-50 mx-4 sm:mx-6 lg:mx-8 transition-all duration-300 transform ${
      ...
      <div className="max-w-7xl mx-auto">
        <div className="relative bg-gradient-to-r from-red-500 via-red-600 to-red-700 text-white rounded-lg shadow-2xl border border-red-400/30 backdrop-blur-sm">
          ...
          <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23ffffff" fill-opacity="0.05"%3E%3Ccircle cx="30" cy="30" r="1"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-20 rounded-lg"></div>
          ...
          <div className="absolute bottom-0 left-0 right-0 h-1 bg-red-800/30 rounded-b-lg overflow-hidden">
            <div 
              className="h-full bg-gradient-to-r from-yellow-400 to-orange-400 transition-all duration-300 ease-linear rounded-b-lg"
              style={{
                animation: `shrink ${dismissTime}ms linear`,
